<!--
	git:https://github.com/charliekassel/vuejs-datepicker
-->
<template>
  <span class="vdp-datepicker" :class="[wrapperClass, isRtl ? 'rtl' : '']">
    <span :class="{'input-group' : bootstrapStyling}">
      <!-- Calendar Button -->
...
.sl-input {
  ...
  &.date {
    ...
    .input-icon-right("../img/calendar.png";
    top 2px right 2px);
  }
}
</style>
...
.vdp-datepicker__calendar
    ...
    header
        ...
        .prev
            &:after
                border-right 10px solid #ffebc8
                margin-left -5px
            &.disabled:after
