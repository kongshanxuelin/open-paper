    ...
    css: {
      ...
      default () {
        return {
          ...
          ascendingIcon: 'icon sumscope-icon icon-caret-up',
          descendingIcon: 'icon sumscope-icon icon-caret-down',
...
<style scoped>
  ...
  .vuetable tbody tr:nth-child(odd){
  	background: #121a19;
  }
  .vuetable tbody tr:nth-child(even){
  	background: #172422;
  }
  .vuetable tbody td{
  	padding: 8px;
