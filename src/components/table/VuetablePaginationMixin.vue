    ...
    css: {
      ...
      default () {
        return {
          ...
          icons: {
            first: 'icon sumscope-icon icon-verticle-right',
            prev: 'icon sumscope-icon icon-left',
            next: 'icon sumscope-icon icon-right',
            last: 'icon sumscope-icon icon-verticle-left'
          }
        }
      }
    },
