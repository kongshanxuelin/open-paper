    ...
    <div class="uploadBox">
        ...
        <form role="form" enctype="multipart/form-data" @submit.prevent="onSubmit">
            ...
            <div class="uploadBoxMain" v-else>
                ...
                <button class="sl-btn" @click="removeItems">{{removeFileMessage}}</button>
                <div class="loader" v-if="isLoaderVisible">
                    <div class="loaderImg"></div>
                </div>
            </div>
            <div>
                <button type="submit" class="sl-btn btn-primary btn-black btn-round" :disabled="itemsAdded < minItems || itemsAdded > maxItems">
                    {{uploadButtonMessage}}
                </button>
                <button type="button" class="sl-btn btn-default btn-round" @click="removeItems">{{cancelButtonMessage}}</button>
            </div>
            <br>
